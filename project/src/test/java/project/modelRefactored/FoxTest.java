...
public class FoxTest {
    ...
    void testConstructor() {
        ...
        Coordinate expectedHead = new Coordinate(fox.coordinate.left().get());
        Coordinate expectedTail = new Coordinate(fox.tail);
    ...
    void slideCorrect() {
        ...
        int moveSpaces = 2;
        try {
            slidingFox = slidingFox.slide(board.getRowSlice(0), moveSpaces, Direction.RIGHT);
            Coordinate expectedHead = new Coordinate(0, 2);
            Coordinate expectedTail = new Coordinate(0, 3);
        //    assertEquals(expectedHead, slidingFox.coordinate.left().get(), "The head should have moved here");
            assertEquals(expectedTail, slidingFox.tail);
        } catch (Exception e) {
            logger.debug(e);
            fail();
        }
